...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { greeting_id: @phrase.greeting_id, name: @phrase.name, position: @phrase.position } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { greeting_id: @phrase.greeting_id, name: @phrase.name, position: @phrase.position } }
